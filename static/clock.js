...
let txt12 = '<text x="0" y="0" class="text12 texty dials">60</text>';
let txt6 = '<text x="0" y="0" class="text6 texty dials">30</text>';
let txt9 = '<text x="0" y="0" class="text9 texty dials">45</text>';
...
svgObj.innerHTML = '<circle cx="20" cy="20" r="19" /><g class="marks">' + marks + '</g>' + txt + txt12 + txt6 + txt9 + index;
//console.log(txt);
