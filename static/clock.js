...
svgObj.innerHTML = '<circle cx="20" cy="20" r="19" /> <circle class="inner_dial" stroke-dasharray="2,2" cx="13" cy="13" r="7"/><circle class="inner_dial2" cx="13" cy="28" r="7"/><g class="marks">' + marks + '</g>' + txt + index;
//console.log(txt);
